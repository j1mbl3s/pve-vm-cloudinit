...
# pve-vm-cloudinit.sh - A set of Bash scripts to help manage the QEMU VM lifecycle
# on Proxmox VE nodes for cloud-init VM templates with customized cloud-init configs.
# https://github.com/j1mbl3s/pve-vm-cloudinit
# Copyright (C) 2024  Jaime Jackson-Block
#
